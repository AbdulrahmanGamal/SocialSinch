...
public class Nanowebm implements Parcelable
{
    ...
    public final static Parcelable.Creator<Nanowebm> CREATOR = new Creator<Nanowebm>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Nanowebm createFromParcel(Parcel in) {
            Nanowebm instance = new Nanowebm();
        ...
        public Nanowebm[] newArray(int size) {
            return (new Nanowebm[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nanowebm) == false) {
            return false;
        }
        Nanowebm rhs = ((Nanowebm) other);
