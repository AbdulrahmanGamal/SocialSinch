...
public class Nanogif implements Parcelable
{
    ...
    @Expose
    private long size;
    public final static Parcelable.Creator<Nanogif> CREATOR = new Creator<Nanogif>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Nanogif createFromParcel(Parcel in) {
            Nanogif instance = new Nanogif();
        ...
        public Nanogif[] newArray(int size) {
            return (new Nanogif[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nanogif) == false) {
            return false;
        }
        Nanogif rhs = ((Nanogif) other);
