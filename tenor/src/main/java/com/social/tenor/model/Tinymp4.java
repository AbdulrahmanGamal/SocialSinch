...
public class Tinymp4 implements Parcelable
{
    ...
    public final static Parcelable.Creator<Tinymp4> CREATOR = new Creator<Tinymp4>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Tinymp4 createFromParcel(Parcel in) {
            Tinymp4 instance = new Tinymp4();
        ...
        public Tinymp4 [] newArray(int size) {
            return (new Tinymp4[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tinymp4) == false) {
            return false;
        }
        Tinymp4 rhs = ((Tinymp4) other);
